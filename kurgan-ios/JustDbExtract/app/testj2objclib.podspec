...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source_files = FileList["build/testj2objclib.h"].include("build/j2objcBuild/dependencies/out/main/**/*.{h,m,cpp,properites,txt}").include("build/j2objcBuild/source/out/main/**/*.{h,m,cpp,properites,txt}").include("build/j2objcBuild/dependencies/exploded/j2objc/co_doppl_lib_androidbase_0_9_0_0/src/**/*.{h,m,cpp,properites,txt}").include("build/j2objcBuild/dependencies/out/test/**/*.{h,m,cpp,properites,txt}").include("build/j2objcBuild/source/out/test/**/*.{h,m,cpp,properites,txt}").to_ary
