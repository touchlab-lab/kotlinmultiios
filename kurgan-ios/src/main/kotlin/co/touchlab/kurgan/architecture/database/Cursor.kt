...
actual interface Cursor{
     ...
     */
    actual fun move(offset: Int): Boolean
     ...
     * @return whether the requested move fully succeeded.
     */
    actual fun moveToPosition(position: Int): Boolean
     ...
     */
    actual fun isBeforeFirst(): Boolean
     ...
     */
    actual fun isAfterLast(): Boolean
     ...
     */
    actual fun getColumnNames(): Array<String>
     ...
     */
    actual fun getType(columnIndex: Int): Int
